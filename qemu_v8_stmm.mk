...
# Targets
################################################################################
all: arm-tf buildroot edk2 linux optee-os qemu soc-term stmm
...
################################################################################
stmm: edk2
	cd $(UEFI_TOOLS_PATH); CROSS_COMPILE=$(AARCH64_CROSS_COMPILE) ./edk2-build.sh \
		-e $(EDK2_PATH) \
		-p $(EDK2_PLAT_PATH) \
		-D EDK2_OUT_DIR=Build/QemuVirtStandaloneMm \
