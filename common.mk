...
OPTEE_OS_COMMON_FLAGS += CFG_CC_OPT_LEVEL=0
OPTEE_OS_COMMON_FLAGS += CFG_WERROR=y
OPTEE_OS_COMMON_FLAGS += CFG_CORE_ASLR=n
OPTEE_OS_COMMON_FLAGS += CFG_TA_ASLR=n
OPTEE_OS_COMMON_FLAGS += CFG_DEBUG_INFO=y
OPTEE_OS_COMMON_FLAGS += CFG_UNWIND=y
OPTEE_OS_COMMON_FLAGS += CFG_TEE_CORE_DEBUG=y
#OPTEE_OS_COMMON_FLAGS += CFG_ENABLE_EMBEDDED_TESTS=n
OPTEE_OS_COMMON_FLAGS += CFG_DT_DRIVER_EMBEDDED_TEST=n
OPTEE_OS_COMMON_FLAGS += CFG_TEE_CORE_EMBED_INTERNAL_TESTS=n
OPTEE_OS_COMMON_FLAGS += CFG_STACK_TMP_EXTRA=4096
