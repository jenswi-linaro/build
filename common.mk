...
BR2_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_AES=y
BR_LOCAL_MK_OVERRIDES += GST1_PLUGINS_BAD_OVERRIDE_SRCDIR="$(ROOT)/gstreamer/subprojects/gst-plugins-bad"
BR_LOCAL_MK_OVERRIDES += GST1_PLUGINS_BASE_OVERRIDE_SRCDIR="$(ROOT)/gstreamer/subprojects/gst-plugins-base"
BR_LOCAL_MK_OVERRIDES += GSTREAMER1_OVERRIDE_SRCDIR="$(ROOT)/gstreamer/subprojects/gstreamer"
...
OPTEE_OS_COMMON_FLAGS += CFG_CORE_ASLR=n CFG_TA_ASLR=n
OPTEE_OS_COMMON_FLAGS += CFG_SECURE_DATA_PATH=y CFG_CORE_DYN_RSTMEM=y
OPTEE_OS_COMMON_FLAGS += CFG_CACHE_API=y
